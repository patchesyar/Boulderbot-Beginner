...
Twitch_Password = 'oauth:xxxxxxxxxxx'   # OAuth for above Twitch.TV account, http://www.twitchapps.com/tmi/
                                        # note that you must be logged in as THE BOT to get the proper oauth
Twitch_Channel = '<DestinationChannel>'  # Twitch.TV channel to connect to

"""
Twitch_Username= 'boulderbot'
Twitch_Password= 'oauth:134afadf75hxc752345' (this is not a real oauth)
Twitch_Channel= 'tomdiamond'
"""
...
class Twitchy:
    def __init__(self):
                print("Welcome to Boulderbot Beginner version 1.0!")
